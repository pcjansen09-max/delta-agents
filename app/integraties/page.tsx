...
const INTEGRATIONS = [
  ...
  { name: 'Microsoft Outlook', cat: 'communicatie', desc: 'Koppel je Outlook inbox voor automatische e-mailverwerking.', slug: null, brand: '#0078D4', label: 'OL', status: 'available' },
  { name: 'Microsoft Teams', cat: 'communicatie', desc: 'Ontvang meldingen en geef instructies via Teams-berichten.', slug: null, brand: '#6264A7', label: 'T', status: 'available' },
  ...
  { name: 'SMS / Tekstbericht', cat: 'communicatie', desc: 'Stuur automatische sms-berichten voor bevestigingen en herinneringen.', slug: null, brand: '#2563EB', label: 'SMS', status: 'available' },
  ...
  { name: 'Facebook Messenger', cat: 'communicatie', desc: 'Beantwoord berichten van jouw Facebook-pagina automatisch.', slug: null, brand: '#0084FF', label: 'FM', status: 'soon' },
  ...
  { name: 'Outlook Calendar', cat: 'agenda', desc: 'Synchroniseer afspraken met je Microsoft agenda.', slug: null, brand: '#0078D4', label: 'OC', status: 'available' },
  ...
  { name: 'Acuity Scheduling', cat: 'agenda', desc: 'Koppel je Acuity agenda voor automatische boekingen.', slug: null, brand: '#1C3C5A', label: 'AS', status: 'available' },
  { name: 'SimplyBook.me', cat: 'agenda', desc: 'Populair bij kappers en beauty salons — volledig geïntegreerd.', slug: null, brand: '#FF6B35', label: 'SB', status: 'soon' },
  { name: 'Booksy', cat: 'agenda', desc: 'Koppel je Booksy-agenda voor naadloze planning.', slug: null, brand: '#FF585B', label: 'BK', status: 'soon' },

  // Boekhouding
  { name: 'Moneybird', cat: 'boekhouding', desc: 'Maak facturen en offertes direct in Moneybird — de populairste keuze voor Nederlands MKB.', slug: null, brand: '#1AB5C1', label: 'MB', status: 'available' },
  { name: 'Exact Online', cat: 'boekhouding', desc: 'Synchroniseer facturen, debiteuren en projecten met Exact Online.', slug: null, brand: '#ED7D31', label: 'EX', status: 'available' },
  { name: 'Snelstart', cat: 'boekhouding', desc: 'Verwerk administratie direct in Snelstart zonder handmatig invoeren.', slug: null, brand: '#0057A8', label: 'SS', status: 'available' },
  { name: 'AFAS', cat: 'boekhouding', desc: 'Koppel je AFAS-omgeving voor volledige automatisering van facturen.', slug: null, brand: '#0D2B52', label: 'AF', status: 'available' },
  { name: 'Twinfield', cat: 'boekhouding', desc: 'Stuur boekingen en facturen direct naar Twinfield.', slug: null, brand: '#003087', label: 'TW', status: 'available' },
  { name: 'Unit4', cat: 'boekhouding', desc: 'Integreer met Unit4 voor grotere MKB-bedrijven.', slug: null, brand: '#E31B23', label: 'U4', status: 'available' },
  { name: 'QuickBooks', cat: 'boekhouding', desc: 'Stuur facturen en betalingen door naar QuickBooks.', slug: null, brand: '#2CA01C', label: 'QB', status: 'soon' },
  { name: 'Boekhoudgemak', cat: 'boekhouding', desc: 'Verwerk facturen via Boekhoudgemak voor ZZP\'ers.', slug: null, brand: '#FF6600', label: 'BG', status: 'soon' },

  // Betalen
  { name: 'Mollie', cat: 'betalen', desc: 'Ontvang betalingen via iDEAL, creditcard en meer — de meest gebruikte betaaloplossing in Nederland.', slug: null, brand: '#2D2D2D', label: 'Mo', status: 'available' },
  { name: 'Stripe', cat: 'betalen', desc: 'Verwerk internationale betalingen en abonnementen via Stripe.', slug: 'stripe', brand: '#635BFF', label: 'St', status: 'available' },
  { name: 'iDEAL', cat: 'betalen', desc: 'Stuur directe iDEAL-betaallinks naar klanten via WhatsApp.', slug: null, brand: '#CC0066', label: 'iD', status: 'available' },
  { name: 'Buckaroo', cat: 'betalen', desc: 'Verwerk betalingen via Buckaroo — populair bij Nederlandse webshops.', slug: null, brand: '#00A3A1', label: 'BU', status: 'available' },
  ...
  { name: 'MultiSafepay', cat: 'betalen', desc: 'Nederlandse betaalprovider met alle gangbare betaalmethodes.', slug: null, brand: '#0F4C81', label: 'MS', status: 'soon' },

  // CRM
  { name: 'Teamleader', cat: 'crm', desc: 'Sync klantgegevens, offertes en projecten met Teamleader Focus.', slug: null, brand: '#FF5500', label: 'TL', status: 'available' },
  ...
  { name: 'Pipedrive', cat: 'crm', desc: 'Update deals en contacten in Pipedrive automatisch na elk gesprek.', slug: 'pipedrive', brand: '#00B050', label: 'PD', status: 'available' },
  { name: 'ActiveCampaign', cat: 'crm', desc: 'Trigger marketing-automations in ActiveCampaign op basis van klantgesprekken.', slug: 'activecampaign', brand: '#004FD6', label: 'AC', status: 'available' },
  { name: 'Zoho CRM', cat: 'crm', desc: 'Synchroniseer contacten en deals met Zoho CRM.', slug: 'zoho', brand: '#E42527', label: 'ZO', status: 'soon' },
  { name: 'Freshdesk', cat: 'crm', desc: 'Maak automatisch tickets aan in Freshdesk bij klachten.', slug: 'freshdesk', brand: '#0AB5B1', label: 'FD', status: 'soon' },

  // E-commerce
  { name: 'Shopify', cat: 'ecommerce', desc: 'Beantwoord bestellingsvragen en verwerk retouren via je Shopify-winkel.', slug: 'shopify', brand: '#96BF48', label: 'Sh', status: 'available' },
  { name: 'WooCommerce', cat: 'ecommerce', desc: 'Koppel je WordPress/WooCommerce webshop voor orderverwerking.', slug: 'woocommerce', brand: '#7F54B3', label: 'WC', status: 'available' },
  { name: 'Bol.com', cat: 'ecommerce', desc: 'Beheer jouw Bol.com verkopersaccount automatisch.', slug: null, brand: '#0000A4', label: 'bol', status: 'available' },
  { name: 'Lightspeed', cat: 'ecommerce', desc: 'Integreer met Lightspeed POS voor retail en horeca.', slug: null, brand: '#FF4D00', label: 'LS', status: 'available' },
  { name: 'Magento', cat: 'ecommerce', desc: 'Verwerk orders en klantverzoeken via Magento.', slug: null, brand: '#EE672F', label: 'MG', status: 'soon' },
  { name: 'Etsy', cat: 'ecommerce', desc: 'Automatiseer klantcommunicatie voor jouw Etsy-winkel.', slug: 'etsy', brand: '#F56400', label: 'Et', status: 'soon' },
  ...
  // Overig
  { name: 'Zapier', cat: 'overig', desc: 'Koppel 5.000+ apps via Zapier-automations — onbeperkte mogelijkheden.', slug: 'zapier', brand: '#FF4A00', label: 'Z', status: 'available' },
  { name: 'Make (Integromat)', cat: 'overig', desc: 'Bouw complexe automations via Make-scenario\'s.', slug: null, brand: '#6D00CC', label: 'Mk', status: 'available' },
  ...
  { name: 'Microsoft Excel', cat: 'overig', desc: 'Exporteer data automatisch naar Excel-bestanden.', slug: null, brand: '#217346', label: 'XL', status: 'available' },
  { name: 'Twilio', cat: 'overig', desc: 'Stuur SMS en voice-berichten via Twilio.', slug: 'twilio', brand: '#F22F46', label: 'Tw', status: 'available' },
  { name: 'Monday.com', cat: 'overig', desc: 'Update projectboards in Monday.com automatisch.', slug: 'monday', brand: '#FF3D57', label: 'Mo', status: 'soon' },
...
function AppIcon({ app, size = 52 }: { app: Integration; size?: number }) {
  if (app.slug) {
...
function IntegCard({ app }: { app: Integration }) {
...
function CatSection({ cat, apps }: { cat: string; apps: Integration[] }) {
  return (
        ...
        <div style={{ background: '#fff', borderBottom: '1px solid #E8E8E4', padding: '80px 24px 56px' }}>
          <div style={{ maxWidth: 720, margin: '0 auto', textAlign: 'center' }}>
            ...
            <div style={{ position: 'relative', maxWidth: 560, margin: '0 auto' }}>
              <svg style={{ position: 'absolute', left: 18, top: '50%', transform: 'translateY(-50%)' }} width={18} height={18} viewBox="0 0 24 24" fill="none" stroke="#94A3B8" strokeWidth={2}>
            ...
            <div style={{ display: 'flex', gap: 12, justifyContent: 'center', flexWrap: 'wrap' as const }}>
              ...
              <Link
                ...
                style={{
                  ...
                  padding: '12px 24px', borderRadius: 12, textDecoration: 'none',
                  border: '1.5px solid #E8E8E4', transition: 'all 0.2s',
                }}
              >
                Bekijk prijzen
              </Link>
